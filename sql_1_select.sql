...
-- Selecting the world db to work on first!
USE world;
#
# Table: City
...
SELECT *
FROM city
WHERE countrycode IN ('tjk', 'mrt', 'png', 'and', 'sjm');
#
#
...
FROM country
WHERE population BETWEEN 800 AND 20000;
#
#
# 16: Get the name of the countries with a independence year (indepyear) before year 0
SELECT `name`, indepyear AS 'YEAR OF FREEDOM'
FROM country
WHERE indepyear < 0;
#
#
...
SELECT `name`, indepyear AS 'سال آزادی', population
FROM country
